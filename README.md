# Bootstrap3 for OMP 3+

A community-built theme for OMP 3+ that implements Bootstrap 3 components.

## Installation

1. Download the [latest release](https://github.com/PublishingWithoutWalls/omp-bootstrap3/releases).
2. Unpack the .zip file and move the `omp-bootstrap3` directory to your OMP installation at `/plugins/themes/bootstrap3`.
3. Login to the admin area of your OMP website. Browse to the Settings > Website > Plugins page and enable the Bootstrap 3 theme.
...
Some versions of the Bootstrap3 theme are only compatible with certain releases of OMP. This release list will indicate which versions are compatible.

## Project Aims

This project was born at the [2016 PKP Sprint](https://pkp.sfu.ca/2016/04/29/sprinting-in-montreal/) in Montreal. It aims to provide a common starting point for anyone who wants to build a custom theme for OMP 3+.
...
This theme is a work-in-progress. It may not support all features of OMP 3 and some of the bundled themes could use some polish. It's intended to act as a base for custom development, but many journals may use it out-of-the-box.
